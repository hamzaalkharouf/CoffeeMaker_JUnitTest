...
public class Recipe {
    ...
    public void setAmtChocolate(String chocolate) throws RecipeException,NumberFormatException {
    	...
    	try {
    		...
    		//1. correcting the expception message ("Units of chocolate must be a positive integer");
    		//2. throw new RecipeException("Units of chocolate must be a positive integer");
    ...
    public void setAmtMilk(String milk)  throws RecipeException,NumberFormatException {
    	...
    	try {
    		...
    		//1. correcting the expception message ("Units of milk must be a positive integer");
    		//2. throw new RecipeException("Units of milk must be a positive integer");
    	}
		if (amtMilk >= 0) {
    ...
    public void setAmtSugar(String sugar) throws RecipeException,NumberFormatException {
    	...
    	try {
    		...
    		//1. correcting the expception message ("Units of sugar must be a positive integer");
    		//2. throw new RecipeException("Units of sugar must be a positive integer");
    	}
		if (amtSugar >= 0) {
    ...
    public void setPrice(String price) throws RecipeException,NumberFormatException {
    	...
    	try {
    		...
    		//1. correcting the expception message ("Price must be a positive integer");
    		//2. throw new RecipeException("Price must be a positive integer");
    	}
		if (amtPrice >= 0) {
			this.price = amtPrice;
		} else {
    ...
    public String toString() {
    	...
    	StrBuf.append(price).append('\n');;
    	StrBuf.append(amtCoffee).append('\n');;
    	StrBuf.append(amtMilk).append('\n');;
    	StrBuf.append(amtSugar).append('\n');;
    	StrBuf.append(amtChocolate).append('\n');;	
